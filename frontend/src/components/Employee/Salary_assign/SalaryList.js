    ...
    return (
        <div className=" overflow-x-auto  ">
            ...
            <div className="flex flex-row justify-between items-center px-8 py-4">
                <div>
                    <h1 className=" text-lg font-semibold text-left">Salary Details</h1>
                    <p className="mt-1 text-sm font-normal text-gray-500 0">Easily access stored employee salary details
