                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    ...
                    <div className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-0 lg:mx-0 lg:flex lg:max-w-none">
                        <div className="p-8 sm:p-10 lg:flex-auto">
                            <h3 className="text-2xl font-bold tracking-tight text-gray-900">TOMATO</h3>
                            <p className="mt-6 text-base leading-7 text-gray-600">Experience the vibrant flavor and succulent juiciness of our farm-grown tomatoes, nurtured under the sun
                                for unrivaled freshness. From plump cherry tomatoes to robust heirloom varieties, each fruit embodies the rich taste of our dedication to quality.</p>
