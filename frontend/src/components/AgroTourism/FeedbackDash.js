...
export default function FeedbackDashboard() {
    ...
    const renderBarChart = () => {
        ...
        // Display total number of feedbacks
    ...
    return (
        <div className="overflow-x-auto">
            ...
            <div className="text-center mx-auto px-4 py-4 w-fit border-2 rounded-md border-white bg-gradient-to-r from-blue-100 to-green-100"><text ref={totalFeedbacksRef}></text></div>
            <div><br/></div>
            {loading ? (
                <div>Loading...</div>
