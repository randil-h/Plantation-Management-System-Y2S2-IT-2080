...
export default function Chemicals_page() {
                        ...
                        <div className="mt-20 ml-52 mr-52">
                            <div
                                ...
                                <div className="flex justify-between items-center">
                                    <h1 className="-mx-3 block rounded-lg px-3 py-2 text-2xl font-semibold leading-7 text-green-700">Chemical List</h1>
                                    <div className="space-x-4 mt-11">
                                        <Link to="../../chemicallist">
                                            <button
